...
import 'onboarding_page4_model.dart';
export 'onboarding_page4_model.dart';

class OnboardingPage4Widget extends StatefulWidget {
  const OnboardingPage4Widget({super.key});

  static String routeName = 'Onboarding_page4';
  static String routePath = '/onboardingPage4';
...
class _OnboardingPage4WidgetState extends State<OnboardingPage4Widget> {
  late OnboardingPage4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingPage4Model());
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Explore interactive tools and wellness resources to support your mental health journey.',
