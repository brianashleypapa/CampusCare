...
import 'mood_tracker3_new_activity_model.dart';
export 'mood_tracker3_new_activity_model.dart';

class MoodTracker3NewActivityWidget extends StatefulWidget {
  const MoodTracker3NewActivityWidget({super.key});

  static String routeName = 'mood_tracker3NewActivity';
  static String routePath = '/moodTracker3NewActivity';

  @override
  State<MoodTracker3NewActivityWidget> createState() =>
      _MoodTracker3NewActivityWidgetState();
}

class _MoodTracker3NewActivityWidgetState
    extends State<MoodTracker3NewActivityWidget> {
  late MoodTracker3NewActivityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MoodTracker3NewActivityModel());
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return MoodComponentWidget(
                            key: Key(
                                'Keyxw3_${listViewIndex}_of_${listViewMoodLogRecordList.length}'),
                            ...
                            activities: listViewMoodLogRecord.activities,
                          );
                        },
                      );
                    },
