...
class _HomepageWidgetState extends State<HomepageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.timeZoneName = await actions.timeZone1();
      _model.randomQuote = await queryQuoteGeneratorRecordOnce(
        queryBuilder: (quoteGeneratorRecord) => quoteGeneratorRecord.where(
          'category',
          isEqualTo: functions.getRandomQuote(),
        ),
        singleRecord: true,
      ).then((s) => s.firstOrNull);
      FFAppState().randomQuote = _model.randomQuote!.quote;
      FFAppState().randomAuthor = _model.randomQuote!.author;
      safeSetState(() {});
    });
                        ...
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context
                                        .pushNamed(UpdatesPageWidget.routeName);
                                  },
                                  child: Text(
                                    'More',
                                    style: FlutterFlowTheme.of(context)
                              ...
                              child: StreamBuilder<List<NewsRecord>>(
                                stream: queryNewsRecord(
                                  queryBuilder: (newsRecord) =>
                                      newsRecord.orderBy('publishedTime'),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            ...
                                            queryParameters: {
                                              ...
                                              'titleIndex': serializeParam(
                                                listViewNewsRecord.newsTitle,
                                                ParamType.String,
                                              ),
                                            }.withoutNulls,
                                          );
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                24.0, 32.0, 24.0, 0.0),
                            child: Text(
                              '${FFAppState().randomQuote} - ${FFAppState().randomAuthor}',
                                    ...
                                    Expanded(
                                      child: Stack(
                                        ...
                                        children: [
                                          ...
                                          if (FFAppState().widgetVisibility ==
                                              false)
                                            Container(
                                              width: 170.0,
                                              height: 50.0,
                          ...
                          Stack(
                            children: [
                              if (FFAppState().widgetVisibility == true)
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 24.0, 0.0, 0.0),
                                  child: Row(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                await launchURL(
                                                    '\"gcc@umak.edu.ph\" <gcc@umak.edu.ph>');
                                              },
                                              child: Text(
                                                'gcc@umak.edu.ph',
                                                style: FlutterFlowTheme.of(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                await launchURL(
                                                    'https://www.facebook.com/UMakCGCS');
                                              },
                                              child: Text(
                                                'UMak Center for Guidance and Counseling Services',
                                                textAlign: TextAlign.center,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                              ...
                              if (FFAppState().widgetVisibility == false)
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 24.0, 0.0, 0.0),
                                  child: Column(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      'Unit 227 Second Floor, Regalia Park Towers, 150 P. Tuazon Blvd., Cubao, Quezon City',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      'UST Psychotrauma (via appointment)\nRoom 104 (The Meeting Room), Ground Floor, Thomas Aquinas Research Complex (TARC), University of Santo Tomas, Manila',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
