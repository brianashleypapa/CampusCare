...
import 'reservation_page22_model.dart';
export 'reservation_page22_model.dart';

class ReservationPage22Widget extends StatefulWidget {
  const ReservationPage22Widget({
    super.key,
  ...
  static String routeName = 'Reservation_Page22';
  static String routePath = '/reservationPage22';

  @override
  State<ReservationPage22Widget> createState() =>
      _ReservationPage22WidgetState();
}

class _ReservationPage22WidgetState extends State<ReservationPage22Widget> {
  late ReservationPage22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReservationPage22Model());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ClassesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final reservationPage22ClassesRecord = snapshot.data!;
                                                  ...
                                                  onChange: (DateTimeRange?
                                                    ...
                                                    if (_model
                                                      ...
                                                      ScaffoldMessenger.of(
                                                        ...
                                                        SnackBar(
                                                          content: Text(
                                                            'No Available Slots for the Upcoming Weeks!',
                                                            style: TextStyle(
                                                    ...
                                                    options: functions
                                                        .getAvailableSlots(
                                                            ...
                                                            _model
                                                                .calendarSelectedDay!
                                                                .start,
                                                            reservationPage22ClassesRecord
                                                                .availability
                                                                .toList())!
                                                        .map((e) =>
                                                            dateTimeFormat(
