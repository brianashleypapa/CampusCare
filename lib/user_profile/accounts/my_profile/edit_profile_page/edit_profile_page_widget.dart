...
class EditProfilePageWidget extends StatefulWidget {
  ...
  static String routeName = 'EditProfile_page';
...
class _EditProfilePageWidgetState extends State<EditProfilePageWidget> {
  ...
  void initState() {
    ...
    _model.txtUNameTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.userName, ''));
    _model.txtUNameFocusNode ??= FocusNode();

    _model.txtUBioTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.userBio, ''));
    _model.txtUBioFocusNode ??= FocusNode();
                            ...
                            children: [
                              ...
                              AuthUserStreamWidget(
                                builder: (context) => Container(
                                  width: 200.0,
                                  child: TextFormField(
                                    controller: _model.txtUNameTextController,
                                    focusNode: _model.txtUNameFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .txtUNameTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                            ...
                            children: [
                              ...
                              AuthUserStreamWidget(
                                builder: (context) => Container(
                                  width: 200.0,
                                  child: TextFormField(
                                    controller: _model.txtUBioTextController,
                                    focusNode: _model.txtUBioFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      isDense: true,
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .txtUBioTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                        ...
                        child: Container(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await currentUserReference!
                                  .update(createUsersRecordData(
                                userName: _model.txtUNameTextController.text,
                                userBio: _model.txtUBioTextController.text,
                              ));
